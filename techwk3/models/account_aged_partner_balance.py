...
class AgedReceivableCustomHandler(models.AbstractModel):
    ...
    # It's necessary to recreate the entire method, then add changes to it.
    def _aged_partner_report_custom_engine_common(self, options, internal_type, current_groupby, next_groupby, offset=0, limit=None):
        ...
        # add ref, invoice_user_id to column selction
        ...
        query = f"""
            ...
            SELECT
                ...
                ARRAY_AGG(move.ref) AS ref,
                ARRAY_AGG(move.invoice_user_id) AS invoice_user_id,
                {select_period_query}
